<template>
    <div class="box">
        <h2 class="subtitle is-4 has-text-centered">Ingreso</h2>
            <div>
                ...
                <div class="field has-text-centered">
                    <p class="control">
                        <button class="button" @click="checkForm">Ingresar</button>
                    </p>
                </div>
            </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        checkForm(e) {
            ...
            if(!exist){
                this.errors.push('Debes registrarte para ingresar.');
            }
            if (!this.email) {
